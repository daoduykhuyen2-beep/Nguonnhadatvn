  ...
  return (
    <div className="container-app max-w-3xl py-12">
      ...
      <div className="mt-6 space-y-4 leading-relaxed text-ink-soft">
        ...
        <h2 className="text-lg font-bold text-ink pt-2">Chúng tôi làm gì?</h2>
        <p>
          Nền tảng cung cấp một hệ sinh thái đầy đủ cho cả người mua, người bán và nhà môi giới. Với người bán và môi giới,
          chúng tôi mang đến công cụ đăng tin trực quan, quản lý tin hiệu quả, hệ thống đẩy tin thông minh và tối ưu SEO
          giúp tin đăng tiếp cận đúng đối tượng khách hàng đang có nhu cầu. Với người mua, chúng tôi xây dựng kho nhà phố
          quy mô toàn quốc, cho phép tìm kiếm theo khu vực, mức giá, diện tích và loại hình một cách dễ dàng, kèm hình ảnh
        ...
        <h2 className="text-lg font-bold text-ink pt-2">Giá trị cốt lõi</h2>
        <p>
          <strong>Minh bạch</strong> là nguyên tắc hàng đầu của chúng tôi. Mọi thông tin về vị trí, diện tích, mức giá và
          pháp lý đều được trình bày rõ ràng, không che giấu. <strong>Tin cậy</strong> đến từ việc chúng tôi ưu tiên nguồn
          hàng chính chủ và đội ngũ tư vấn tận tâm, luôn đặt lợi ích của khách hàng lên trước. <strong>Hiệu quả</strong>
          thể hiện qua công nghệ giúp rút ngắn khoảng cách giữa người có nhu cầu mua và người bán, để giao dịch diễn ra
          suôn sẻ trong thời gian ngắn nhất.
        </p>
        <p>
          Chúng tôi cũng đặc biệt coi trọng <strong>trải nghiệm người dùng</strong>. Giao diện được thiết kế hiện đại,
          tối giản, thân thiện trên cả máy tính và điện thoại, giúp bất kỳ ai — dù không rành công nghệ — cũng có thể dễ
          dàng tìm nhà, đăng tin hay liên hệ chỉ trong vài thao tác. Bên cạnh đó, chuyên mục tin tức và cẩm nang bất động
          sản được biên tập thường xuyên, cung cấp kiến thức pháp lý, kinh nghiệm mua bán, phân tích thị trường và những
          lời khuyên hữu ích để khách hàng ra quyết định sáng suốt.
        </p>
