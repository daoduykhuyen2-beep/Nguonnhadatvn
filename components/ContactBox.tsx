...
export default function ContactBox({ postId, contactName, contactPhone, favorited = false }: { postId: number; contactName?: string | null; contactPhone?: string | null; favorited?: boolean }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {contactPhone && <a href={"tel:" + contactPhone} className="block w-full rounded-xl bg-brand px-4 py-3 text-center text-sm font-semibold text-white transition hover:bg-brand-dark">📞 {contactPhone}</a>}
